...
@section('content')<!--<script src="{{asset('/js/roster-gen.js')}}"></script>-->
              ...
              <div class="col-lg-12 col-md-12">
                <div class="widget">            
                  ...
                  <div class="widget-body" >
                    <table class="table table-hover no-margin" id="createTable" >
                        <tr>
                          <td rowspan="2" style="vertical-align:middle" id="thID">Day</td>
                          <td colspan="5" id="thID">Day(7:00 to 15:00)</td>
                          <td colspan="5" id="thID">Evening(15:00 to 23:00)</td>
                          <td colspan="5" id="thID">Night(23:00 to 7:00)</td>
                        </tr>
                        <tr>
                          <td id="thID">Shift Leader</td>
                          <td id="thID">Sur</td>
                          <td id="thID">BO</td>
                          <td id="thID">IIG</td>
                          <td id="thID">ICX</td>
...
<!--*********************************************FRIDAY NIGHT******************************************** -->
                    ...
                    <div style="margin-top:1%;">
                      <form action="{{url('insertRoster')}}" id="weekRosterForm" method="post">
                        <?php for($i=1;$i<106;$i++){ ?>
                          <input type="hidden" id="<?php echo 'cell'.$i; ?>" name="<?php echo 'cell'.$i; ?>" value="">
                        <?php } ?>
                          <input type="text" id="rosterDate" name="rosterDate" value="">
                          <!-- <input type="hidden" id="rosterDateValue" name="rosterDateValue" value=""> -->
                         <!--  <div class="form-group">
                              <div class='input-group date' id='rosertDate'>
